...
public class forintent implements Serializable, Comparable   <forintent>{
         ...
         *      comment
         */
    public forintent(String date, String time, int systolicPressure, int diastolicPressure, int heartrate, String comment) {
        this.date = date;
        this.time = time;
        ...
        /**
         * Check if two forintent object are equals
         * @param o
         *      another object o
         * @return
    ...
    @Override
    public int compareTo(forintent o) {
